...
public
	...
	private:
		System::Windows::Forms::Label ^ LblOper;
	...
	private:
		System::Windows::Forms::Button ^ btnDivided;

	private:
		System::Windows::Forms::Button ^ btnMultiply;

	private:
		System::Windows::Forms::Button ^ btnRadical;

	private:
		System::Windows::Forms::Button ^ btnDegree;
...
#pragma endregion
	...
	private:
		System::Void btnMinus_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
			float i1, i2, i3;
			this->LblOper->Text = L"���������";
	...
	private:
		System::Void btnDivided_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
	...
	private:
		System::Void btnDegree_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
	...
	private:
		System::Void btnRadical_Click(System::Object ^ sender, System::EventArgs ^ e)
		{
