...
while exiter != "N":
    ...
    flag_uppercase = bool(input("Нужны ли прописные буквы в вашем пароле True or False "))
    flag_lowerrcase = bool(input("Нужны ли строчные букву в вашем пароле True or False "))
